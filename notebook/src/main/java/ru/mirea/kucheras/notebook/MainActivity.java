package ru.mirea.kucheras.notebook;
...
import ru.mirea.kucheras.notebook.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void readFileFromExternalStorage() {
        ...
        String filename = binding.editTextTextPersonName.getText().toString();
    ...
    public void writeFileToExternalStorage() {
        ...
        try {
            ...
            String data = binding.editTextTextPersonName2.getText().toString();
